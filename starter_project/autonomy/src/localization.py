...
class Localization:
    ...
    def __init__(self):
        ...
        respy.Subscriber('/imu/imu_only', Imu, imu_callback)
    ...
    def gps_callback(self, msg: NavSatFix):
        ...
        """
        referencePoint = np.array([42.293195, -83.7096706])
        point = np.array([msg.latitude, msg.longitude])
        self.pose = SE3.from_pos_quat(self.spherical_to_cartesian(point, referencePoint), self.pose.rotation)
