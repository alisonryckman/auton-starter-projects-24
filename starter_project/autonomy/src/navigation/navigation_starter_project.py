...
class Navigation(threading.Thread):
    ...
    def __init__(self, context: Context):
        ...
        with self.state_machine:
            self.state_machine.add("DriveState", DriveState(self.context),
            ...
            self.state_machine.add("TagSeekState", TagSeekState(self.context),
                transitions={"failure": "TagSeekState", "working": "TagSeekState", "success" : "TagSeekState"},
            )
