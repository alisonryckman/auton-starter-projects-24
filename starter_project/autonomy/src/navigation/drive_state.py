...
class DriveState(BaseState):
    ...
    def evaluate(self, ud):
        ...
        drive_cmd = get_drive_command(target, pose, 0.7, 0.2)
        ...
        self.context.rover.send_drive_command(drive_cmd[0])
